 ...
 */
public abstract class BaseDialogFragment<T extends BasePresenter<V>, V> extends DialogFragment {
...
//        getDialog().getWindow().setWindowAnimations(R.style.dialogAnimation); // 添加动画
//    }
